...
str(Stroke)
```
### We have 12 variables in the Stroke dataset. We have different type of data. Our outcome variable "Stroke" is a binary outcome, 1 if the person has had a stroke and 0 meaning that they haven't had a stroke. 

Bmi is seen as a character because of the N/A => we must change N/A strings to real NA in R.
